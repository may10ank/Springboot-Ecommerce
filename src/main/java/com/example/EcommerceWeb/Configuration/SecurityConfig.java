    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http.csrf(csrf->csrf.disable())
                ...
                .authorizeHttpRequests(auth->auth
                        ...
                        .requestMatchers("/api/orders/allOrders","/api/orders/{orderId}","/api/review/add","/api/review/product/{productId}/average-rating","/api/review/product/{productId}/rating-summary","/api/review/product/{productId}/reviews","/api/review/product/{productId}/rating-summary/distribution","/api/review/{productId}/summary","/auth/logout","/api/review/product/{productId}","/api/review/product/{productId}/my-review","/api/review/product/{productId}/can-review").authenticated())
