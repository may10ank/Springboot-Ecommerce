    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http.csrf(csrf->csrf.disable())
                ...
                .authorizeHttpRequests(auth->auth
                        .requestMatchers("/home","/auth/register/user","/auth/register/business","/auth/login","/oauth2/success","/swagger-ui/**","/v3/api-docs/**","/ecommerce/actuator/**","/api/payments/success","/api/payments/cancel","/api/product/getProduct","/api/product/getProduct/{id}","/api/product/search","/api/product/voiceSearch","/api/product/qa/{productId}","/api/product/{productId}/similar","/api/home/stats").permitAll()
